...
document.addEventListener('pointerdown',e=>{if(e.target.closest?.('.rmove3,.peDrag'))document.body.classList.add('raf-dragging61')},true);
const stop=()=>{document.body.classList.remove('raf-dragging61');document.querySelectorAll('.proGuide60').forEach(x=>x.style.display='none')};
