...
function run(){installCss();cleanAddress();repairLinks();document.documentElement.dataset.rafVersion='8.1.0';window.dispatchEvent(new CustomEvent('raf:v800-ready'))}
