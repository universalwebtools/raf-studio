// RAF.studio public shell v8.7.1 — clean URLs, privacy, responsive layer
...
function installCss(){if(document.querySelector('link[data-raf-responsive="800"]'))return;const l=document.createElement('link');l.rel='stylesheet';l.href='/responsive-v800.css?v=8.7.0';l.dataset.rafResponsive='800';document.head.appendChild(l)}
...
function run(){installCss();cleanAddress();repairLinks();if(PREVIEW){document.documentElement.classList.remove('raf-public-boot');document.documentElement.classList.add('raf-public-ready')}document.documentElement.dataset.rafVersion='8.7.1';window.dispatchEvent(new CustomEvent('raf:v800-ready'))}
