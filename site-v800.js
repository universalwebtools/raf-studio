// RAF.studio public shell v8.0.0 — clean URLs, privacy, responsive layer
import './privacy-center-v800.js?v=8.0.0';
import './form-protection-v800.js?v=8.0.0';
...
function installCss(){if(document.querySelector('link[data-raf-responsive="800"]'))return;const l=document.createElement('link');l.rel='stylesheet';l.href='/responsive-v800.css?v=8.0.0';l.dataset.rafResponsive='800';document.head.appendChild(l)}
...
function run(){installCss();cleanAddress();repairLinks();document.documentElement.dataset.rafVersion='8.0.0';window.dispatchEvent(new CustomEvent('raf:v800-ready'))}
