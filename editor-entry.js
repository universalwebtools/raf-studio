const params=new URLSearchParams(location.search),mode=params.get('editor'),requested=params.get('ev')||'6.5.1';
if(mode==='direct'||mode==='1'){
 ...
 (async()=>{try{
   ...
   if(portfolio){
     ...
     if(['6.5','6.5.1'].includes(requested)){
     ...
     if(['4.5','4.6','4.7','5.0','5.4','5.5','6.0','6.1','6.2','6.2.1','6.3','6.3.1','6.4','6.5','6.5.1'].includes(requested))await import('./editor-motion-fix-v45.js?v=4.5.0');
     ...
     if(['5.5','6.0','6.1','6.2','6.2.1','6.3','6.3.1','6.4','6.5','6.5.1'].includes(requested))await import('./editor-sections-v55.js?v=5.5.0');
     ...
     if(requested==='6.0'){
     ...
     }else if(['6.1','6.2','6.2.1','6.3','6.3.1','6.4','6.5','6.5.1'].includes(requested)){
       await import('./editor-pro-v61.js?v=6.5.1');
       if(!['6.3','6.3.1','6.4','6.5','6.5.1'].includes(requested))await import('./editor-history-v61.js?v=6.2.1');
       if(['6.2','6.2.1','6.3','6.3.1','6.4','6.5','6.5.1'].includes(requested))await import('./custom-sections-editor-v62.js?v=6.5.1');
       ...
       if(['6.4','6.5','6.5.1'].includes(requested))await import('./editor-history-preview-v64.js?v=6.5.1');
