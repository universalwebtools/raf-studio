const params=new URLSearchParams(location.search),mode=params.get('editor'),LATEST='7.4.1',requested=params.get('ev')||LATEST;
...
if(editorMode&&requested!==LATEST){const u=new URL(location.href);u.searchParams.set('ev',LATEST);u.searchParams.set('_editorBuild','741');location.replace(u.toString())}
else if(editorMode){
 ...
 (async()=>{try{
  ...
  if(!portfolio){await import('./editor-recovery-v64.js?v=6.5.3');await import('./editor-baseline-sync-v652.js?v=7.4.1')}
  if(portfolio){await import('./portfolio-editor.js?v=6.2.0');await import('./portfolio-page-v4.js?v=4.0.0');await import('./portfolio-chrome-v47.js?v=6.5.3')}
   ...
   await import('./template-runtime-v74.js?v=7.4.1');
   await import('./editor-core-v72.js?v=7.4.1');
   await import('./editor-v70-layout-guard.js?v=7.4.1');
   await import('./editor-templates-v741.js?v=7.4.1');
   await import('./editor-history-v72.js?v=7.4.1');
   await import('./editor-chrome-v73.js?v=7.4.1');
  }
