const params=new URLSearchParams(location.search),mode=params.get('editor'),LATEST='7.7.2',requested=params.get('ev')||LATEST;
...
if(editorMode&&requested!==LATEST){const u=new URL(location.href);u.searchParams.set('ev',LATEST);u.searchParams.set('_editorBuild','772');location.replace(u.toString())}
else if(editorMode){
 ...
 (async()=>{try{
  ...
  if(portfolio){await import('./portfolio-editor.js?v=6.2.0');await import('./portfolio-page-v4.js?v=4.0.0');await import('./portfolio-chrome-v47.js?v=7.7.2')}
   ...
   await import('./template-blueprints-v75.js?v=7.7.2');
   await import('./blueprint-guard-v75.js?v=7.7.2');
   await import('./editor-parity-v752.js?v=7.7.2');
   await import('./editor-core-v760.js?v=7.7.2');
   await import('./editor-v70-layout-guard.js?v=7.7.2');
   await import('./editor-templates-v752.js?v=7.7.2');
   await import('./editor-history-v72.js?v=7.7.2');
   await import('./editor-chrome-v73.js?v=7.7.2');
   await import('./editor-workspace-v760.js?v=7.7.2');
   await import('./editor-widgets-v770.js?v=7.7.2');
