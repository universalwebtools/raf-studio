const params=new URLSearchParams(location.search),mode=params.get('editor'),requested=params.get('ev')||'5.4';
if(mode==='direct'||mode==='1'){
 ...
 (async()=>{try{
   ...
   if(portfolio){
     ...
     await import('./portfolio-chrome-v47.js?v=5.4.0');
   }else{
     ...
     await import('./direct-publish-v32.js?v=5.4.0');
     ...
     if(['4.5','4.6','4.7','5.0','5.4'].includes(requested))await import('./editor-motion-fix-v45.js?v=4.5.0');
     if(['4.6','4.7','5.0','5.4'].includes(requested))await import('./editor-media-section-v46.js?v=4.6.0');
     ...
     if(['5.0','5.4'].includes(requested))await import('./editor-history-v50.js?v=5.4.0');
     if(['5.0','5.4'].includes(requested))await import('./editor-chrome-v50.js?v=5.4.0');
