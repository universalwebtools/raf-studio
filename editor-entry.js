const params=new URLSearchParams(location.search),mode=params.get('editor'),LATEST='6.5.2',requested=params.get('ev')||LATEST;
if((mode==='direct'||mode==='1')&&requested!==LATEST){
 const u=new URL(location.href);u.searchParams.set('ev',LATEST);u.searchParams.set('_editorBuild','652');location.replace(u.toString());
 ...
 (async()=>{try{
   ...
   if(['6.0','6.1','6.2','6.2.1','6.3','6.3.1','6.4','6.5','6.5.1','6.5.2'].includes(requested))await import('./image-webp-v60.js?v=6.5.2');
   if(['6.4','6.5','6.5.1','6.5.2'].includes(requested)&&!portfolio)await import('./editor-recovery-v64.js?v=6.5.2');
   if(!portfolio&&requested==='6.5.2')await import('./editor-baseline-sync-v652.js?v=6.5.2');
   if(portfolio){
     await import('./portfolio-editor.js?v=6.2.0');
     await import('./portfolio-page-v4.js?v=4.0.0');
     await import('./portfolio-chrome-v47.js?v=6.5.2');
   }else{
     ...
     await import('./typography-controller-v65.js?v=6.5.2');
     await import('./editor-media-section-v65.js?v=6.5.2');
     ...
     await import('./editor-pro-v61.js?v=6.5.2');
     await import('./custom-sections-editor-v62.js?v=6.5.2');
     await import('./editor-history-preview-v64.js?v=6.5.2');
     await import('./editor-chrome-v61.js?v=6.5.2');
   }
