const params=new URLSearchParams(location.search),mode=params.get('editor'),LATEST='8.6.0',CURRENT_BUILD='8600',requested=params.get('ev')||LATEST;
...
async function bootCurrent(){
 ...
 try{
  ...
  if(portfolio){await import('./portfolio-editor.js?v=6.2.0');await import('./portfolio-page-v4.js?v=4.0.0');await import('./portfolio-chrome-v47.js?v=7.7.2')}
   ...
   await import('./direct-editor-v3.js?v=8.6.0');
   await import('./editor-ui-v4.js?v=8.6.0');
   await import('./editor-custom-v42.js?v=4.2.0');
   await import('./typography-controller-v65.js?v=6.5.3');
   await import('./editor-media-section-v65.js?v=8.6.0');
   ...
   await import('./editor-pro-v61.js?v=8.6.0-r2');
   ...
   await import('./template-blueprints-v75.js?v=8.6.0');
   await import('./blueprint-guard-v75.js?v=8.6.0');
   await import('./editor-parity-v752.js?v=8.6.0');
   await import('./editor-core-v760.js?v=8.6.0');
   await import('./editor-v70-layout-guard.js?v=7.7.2');
   await import('./editor-templates-v752.js?v=8.6.0');
   await import('./editor-history-v72.js?v=8.6.0');
   await import('./editor-chrome-v73.js?v=8.6.0');
   await import('./editor-workspace-v760.js?v=8.6.0');
   await import('./editor-pages-v860.js?v=8.6.0');
   await import('./editor-widgets-v770.js?v=8.6.0');
   await import('./editor-version-history-v760.js?v=8.6.0');
   await import('./direct-publish-v760.js?v=8.6.0');
  }
...
(async()=>{
 ...
 await import('./site-v800.js?v=8.6.0');
