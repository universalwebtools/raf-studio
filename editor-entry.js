const params=new URLSearchParams(location.search),mode=params.get('editor'),LATEST='8.8.2',CURRENT_BUILD='8820',requested=params.get('ev')||LATEST;
...
async function bootCurrent(){
 ...
 try{
  ...
  if(portfolio){await import('./portfolio-editor.js?v=6.2.0');await import('./portfolio-page-v4.js?v=4.0.0');await import('./portfolio-chrome-v47.js?v=7.7.2')}
   ...
   await import('./editor-core-v760.js?v=8.7.2');await import('./editor-meaningful-undo-v874.js?v=8.7.4');await import('./editor-safe-controls-v876.js?v=8.7.6');await import('./accordion-runtime-v877.js?v=8.8.2');await import('./editor-accordion-v877.js?v=8.8.2');await import('./editor-groups-v880.js?v=8.8.2');
