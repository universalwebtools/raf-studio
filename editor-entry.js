const params=new URLSearchParams(location.search),mode=params.get('editor'),LATEST='7.1',requested=params.get('ev')||LATEST;
...
if(editorMode&&requested!==LATEST){const u=new URL(location.href);u.searchParams.set('ev',LATEST);u.searchParams.set('_editorBuild','710');location.replace(u.toString())}
else if(editorMode){
 ...
 (async()=>{try{
  ...
  if(!portfolio){await import('./editor-recovery-v64.js?v=6.5.3');await import('./editor-baseline-sync-v652.js?v=7.1.0')}
  if(portfolio){await import('./portfolio-editor.js?v=6.2.0');await import('./portfolio-page-v4.js?v=4.0.0');await import('./portfolio-chrome-v47.js?v=6.5.3')}
   ...
   // Shift marquee rejestruje listener PRZED rdzeniem, aby Shift+drag mógł startować także na elemencie.
   await import('./editor-shift-marquee-v71.js?v=7.1.0');
   await import('./editor-core-v70.js?v=7.1.0');
   await import('./editor-v70-layout-guard.js?v=7.1.0');
   await import('./editor-templates-v71.js?v=7.1.0');
   await import('./editor-history-preview-v64.js?v=7.1.0');
   await import('./editor-chrome-v61.js?v=7.1.0');
  }
