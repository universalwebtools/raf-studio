const params=new URLSearchParams(location.search),mode=params.get('editor'),requested=params.get('ev')||'6.3';
if(mode==='direct'||mode==='1'){
 ...
 (async()=>{try{
   ...
   if(['6.0','6.1','6.2','6.2.1','6.3'].includes(requested))await import('./image-webp-v60.js?v=6.3.0');
   if(['6.1','6.2','6.2.1','6.3'].includes(requested)&&!portfolio)await import('./editor-layout-reset-v61.js?v=6.1.0');
   if(portfolio){
     await import('./portfolio-editor.js?v=6.2.0');
     await import('./portfolio-page-v4.js?v=4.0.0');
     await import('./portfolio-chrome-v47.js?v=6.3.0');
   }else{
     ...
     await import('./direct-publish-v32.js?v=6.3.0');
     ...
     if(['4.5','4.6','4.7','5.0','5.4','5.5','6.0','6.1','6.2','6.2.1','6.3'].includes(requested))await import('./editor-motion-fix-v45.js?v=4.5.0');
     if(['4.6','4.7','5.0','5.4','5.5','6.0','6.1','6.2','6.2.1','6.3'].includes(requested))await import('./editor-media-section-v46.js?v=4.6.0');
     ...
     if(['5.5','6.0','6.1','6.2','6.2.1','6.3'].includes(requested))await import('./editor-sections-v55.js?v=5.5.0');
     ...
     }else if(['6.1','6.2','6.2.1','6.3'].includes(requested)){
